#!/usr/bin/env python3
"""PIDM 风格物理信息扩散方案测试入口：聚合 AE + 扩散训练产物，生成统一可视化报告。"""
...
from schemes.pidm_guided.utils.visualization import plot_per_sample_metrics, save_json

SCHEME_LABEL = "PIDM-Guided"
...
def run_eval(run_dir: Path) -> None:
    ...
    if metrics_path.exists():
        ...
        report["diffusion"] = {
            ...
            "mean_physics_residual": metrics.get("mean_physics_residual"),
            "summary": _load_json(diff_dir / "summary.json"),
            "pidm_config": _load_json(diff_dir / "pidm_config.json"),
